...
public static class HangfireConfiguration
{
        ...
        IRecurringJobManager recurringJobManager)
    {
        ...
        recurringJobManager.AddOrUpdate<BatchPredictionJob>(
        ...
        recurringJobManager.AddOrUpdate<CleanupExpiredPredictionsJob>(
        ...
        recurringJobManager.AddOrUpdate<CleanupOutboxJob>(
            "cleanup-outbox",
