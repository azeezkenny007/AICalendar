...
public class HangfireService : IHangfireService
{
    ...
    public Task<string> ScheduleJobAsync<T>(Expression<Func<T, Task>> methodCall, TimeSpan delay)
    {
        try
        {
    ...
    public Task<string> ScheduleRecurringJobAsync<T>(string jobId, Expression<Func<T, Task>> methodCall, string cronExpression)
    {
        try
        {
    ...
    public Task TriggerJobAsync<T>(Expression<Func<T, Task>> methodCall)
    {
        try
        {
